...
.method static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bl;[I)V
    ...
    iget-boolean v0, p1, Landroid/support/v7/widget/bl;->c:Z
    ...
    iget-object v0, p1, Landroid/support/v7/widget/bl;->a:Landroid/content/res/ColorStateList;

    :goto_1
    iget-boolean v1, p1, Landroid/support/v7/widget/bl;->c:Z

    if-eqz v1, :cond_4

    iget-object v1, p1, Landroid/support/v7/widget/bl;->b:Landroid/graphics/PorterDuff$Mode;
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 306
    iget-object v0, p0, Landroid/support/v7/widget/l;->l:Landroid/support/v4/g/n;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/l;->l:Landroid/support/v4/g/n;
    ...
    .line 381
    iget-object v1, p0, Landroid/support/v7/widget/l;->l:Landroid/support/v4/g/n;
    ...
    .line 358
    iget-object v7, p0, Landroid/support/v7/widget/l;->l:Landroid/support/v4/g/n;
...
.method private e(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/bi;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 654
    :cond_0
    sget-object v2, Landroid/support/v7/widget/bi;->a:[I
    ...
    .line 658
    sget-object v2, Landroid/support/v7/widget/bi;->e:[I
...
.method private f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v4}, Landroid/support/v7/widget/bi;->c(Landroid/content/Context;I)I

    move-result v4

    .line 605
    sget-object v5, Landroid/support/v7/widget/bi;->a:[I
    ...
    .line 609
    sget-object v4, Landroid/support/v7/widget/bi;->d:[I
    ...
    .line 613
    sget-object v4, Landroid/support/v7/widget/bi;->b:[I
...
.method a(Landroid/content/Context;Landroid/support/v7/widget/bs;I)Landroid/graphics/drawable/Drawable;
    .locals 2
