...
.method public static a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/f/d$b;I)Landroid/graphics/Typeface;
    .locals 1
    ...
    invoke-interface {v0, p0, p1, p2, p3}, Landroid/support/v4/b/c$a;->a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/f/d$b;I)Landroid/graphics/Typeface;
...
.method public static a(Landroid/content/Context;Landroid/support/v4/content/a/a$a;Landroid/content/res/Resources;IILandroid/support/v4/content/a/b$a;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    .line 124
    :goto_1
    invoke-virtual {p1}, Landroid/support/v4/content/a/a$d;->a()Landroid/support/v4/f/c;
    ...
    invoke-static/range {v0 .. v6}, Landroid/support/v4/f/d;->a(Landroid/content/Context;Landroid/support/v4/f/c;Landroid/support/v4/content/a/b$a;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    ...
    invoke-interface {v0, p0, p1, p2, p4}, Landroid/support/v4/b/c$a;->a(Landroid/content/Context;Landroid/support/v4/content/a/a$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
