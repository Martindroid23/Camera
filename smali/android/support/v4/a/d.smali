...
.method public constructor <init>(Landroid/support/v4/a/c;)V
    ...
    .line 47
    iget-object v1, p1, Landroid/support/v4/a/c;->b:Ljava/util/ArrayList;
    ...
    .line 50
    iget-boolean v1, p1, Landroid/support/v4/a/c;->i:Z
    ...
    .line 56
    iget-object v0, p1, Landroid/support/v4/a/c;->b:Ljava/util/ArrayList;
    ...
    .line 64
    :cond_2
    iget v0, p1, Landroid/support/v4/a/c;->g:I
    ...
    .line 66
    iget-object v0, p1, Landroid/support/v4/a/c;->k:Ljava/lang/String;

    iput-object v0, p0, Landroid/support/v4/a/d;->d:Ljava/lang/String;

    .line 67
    iget v0, p1, Landroid/support/v4/a/c;->m:I
    ...
    .line 69
    iget-object v0, p1, Landroid/support/v4/a/c;->o:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/a/d;->g:Ljava/lang/CharSequence;

    .line 70
    iget v0, p1, Landroid/support/v4/a/c;->p:I

    iput v0, p0, Landroid/support/v4/a/d;->h:I

    .line 71
    iget-object v0, p1, Landroid/support/v4/a/c;->q:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/a/d;->i:Ljava/lang/CharSequence;

    .line 72
    iget-object v0, p1, Landroid/support/v4/a/c;->r:Ljava/util/ArrayList;
    ...
    .line 74
    iget-boolean v0, p1, Landroid/support/v4/a/c;->t:Z
...
.method public a(Landroid/support/v4/a/n;)Landroid/support/v4/a/c;
    ...
    iput v0, v3, Landroid/support/v4/a/c;->c:I
    ...
    iput-object v0, v3, Landroid/support/v4/a/c;->k:Ljava/lang/String;

    .line 122
    iget v0, p0, Landroid/support/v4/a/d;->e:I

    iput v0, v3, Landroid/support/v4/a/c;->m:I

    .line 123
    iput-boolean v7, v3, Landroid/support/v4/a/c;->i:Z
    ...
    iput-object v0, v3, Landroid/support/v4/a/c;->o:Ljava/lang/CharSequence;

    .line 126
    iget v0, p0, Landroid/support/v4/a/d;->h:I

    iput v0, v3, Landroid/support/v4/a/c;->p:I

    .line 127
    iget-object v0, p0, Landroid/support/v4/a/d;->i:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/a/c;->q:Ljava/lang/CharSequence;

    .line 128
    iget-object v0, p0, Landroid/support/v4/a/d;->j:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/a/c;->r:Ljava/util/ArrayList;
    ...
    iput-boolean v0, v3, Landroid/support/v4/a/c;->t:Z
