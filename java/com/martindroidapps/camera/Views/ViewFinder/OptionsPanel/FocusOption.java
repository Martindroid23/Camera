...
public class FocusOption extends b {
    ...
    public FocusOption(Context context) {
        super(context);
        k();
    }
    ...
    public FocusOption(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        k();
    }

    private void k() {
        setImageResource(2131230846);
        setBackgroundText(getContext().getString(2131689551));
    ...
    private boolean l() {
        if (App.b().m() == com.footej.c.a.a.b.m.VIDEO_CAMERA && App.b().f().m().contains(j.INITIALIZED) && App.b().a(k.MANUAL_FOCUS)) {
            return !((d) App.b().f()).S();
        } else {
            return App.b().a(k.MANUAL_FOCUS);
        }
    }
}
