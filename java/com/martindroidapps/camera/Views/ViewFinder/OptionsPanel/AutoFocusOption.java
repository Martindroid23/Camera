...
public class AutoFocusOption extends b<Boolean> implements a<Boolean>, c.a {
    ...
    public AutoFocusOption(Context context) {
        super(context);
        k();
    }
    ...
    public AutoFocusOption(Context context, AttributeSet attributeSet, int i) {
    ...
    private void k() {
        ...
        a((Object) Boolean.valueOf(true), Integer.valueOf(2131230827), "Auto");
        a((Object) Boolean.valueOf(false), Integer.valueOf(2131230889), "Manual");
    }

    public void a(Bundle bundle) {
        super.a(bundle);
        App.a((Object) this);
        setValue(Boolean.valueOf(App.b().a(i.FOCUSMODE, d.AUTO) != d.OFF));
    }
    ...
    public void a(View view, Boolean bool) {
        ...
        if (f.m().contains(j.PREVIEW) && f.a(k.MANUAL_FOCUS)) {
            f.a(bool.booleanValue() ? d.AUTO : d.OFF);
        }
    }
            ...
            case com.h6ah4i.android.widget.verticalseekbar.a.a.Toolbar_contentInsetEndWithActions /*6*/:
                if (aVar.b().length > 0 && aVar.b()[0] == i.FOCUSMODE) {
                    post(new Runnable(this) {
                        final /* synthetic */ AutoFocusOption a;
