...
public class ExposureImageView extends View implements OnTouchListener, a {
    ...
    static /* synthetic */ class AnonymousClass4 {
        ...
        static {
            ...
            try {
                a[c.INACTIVE.ordinal()] = 4;
            } catch (NoSuchFieldError e7) {
            }
            try {
                a[c.COMPENSATION_CHANGE.ordinal()] = 5;
    ...
    private void a() {
        this.f = new Paint();
        this.f.setColor(getResources().getColor(17170456));
        ...
        this.g = new Paint();
        this.g.setColor(getResources().getColor(17170456));
        ...
        this.g.setTextSize((float) com.footej.e.a.a.a(getContext(), 10.0f));
    ...
    public void a(Bundle bundle) {
        ...
        if (rect != null && rect.width() != 0 && rect.height() != 0) {
            this.a.set(rect);
            this.c = bundle.getFloat("ExposureImageViewMoveFactor", 1.0f);
            this.d = bundle.getInt("ExposureImageViewAlphaFactor", 255);
            this.e = bundle.getInt("ExposureImageViewAlphaTextFactor", 0);
            d();
        }
    }
    ...
    public void b(Bundle bundle) {
        App.b((Object) this);
        bundle.putParcelable("ExposureImageViewRectangle", this.a);
        bundle.putFloat("ExposureImageViewMoveFactor", this.c);
        bundle.putInt("ExposureImageViewAlphaFactor", this.d);
        bundle.putInt("ExposureImageViewAlphaTextFactor", this.e);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (d.a(this.c, 1.0f)) {
            ...
            canvas.drawText("exposure", width, height - (((float) this.a.height()) / 6.0f), this.g);
        }
    }

    private void a(final int i) {
        post(new Runnable(this) {
            final /* synthetic */ ExposureImageView b;
    ...
    public void handleExposureEvent(f fVar) {
    ...
    @m(a = ThreadMode.ASYNC)
    public void handleFocusEvent(l lVar) {
        if (lVar.a() == e.UPDATE) {
            postDelayed(new Runnable(this) {
                final /* synthetic */ ExposureImageView a;
    ...
    private DragShadowBuilder a(View view) {
        ...
        return new DragShadowBuilder(this, view) {
            final /* synthetic */ ExposureImageView d;
